  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-800 p-6">
        <h1 className="lg:text-4xl md:text-2xl text-lg text-slate-200 text-center mb-2">
          Welcome, {userName}
        </h1>
        <h2 className="lg:text-3xl md:text-xl text-sm text-slate-200 text-center mb-8">
          Select a Category of Work
        </h2>
        <div className="flex flex-wrap justify-center items-center gap-6">
          {categories.map((category, index) => (
            <div
              key={index}
              className="bg-slate-300 rounded-lg overflow-hidden shadow-lg cursor-pointer w-full sm:w-64 md:w-72"
